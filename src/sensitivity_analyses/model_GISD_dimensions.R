...
# Wave 1:
n1_1a_full_bildung <- bake(file = 'results/fitted_models/SA/FULL_n1_1a_bildung_ml.rds',
                           expr = {
                             gam(cases_wave1_1 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 45) + s(ags2, bs = 're', k = 16) +
                                   s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds, k = 25) + s(TS_Bildung_adj) + s(pop_dens) +
                                   s(perc_service) + s(perc_production) +
                                   offset(log(pop)), data = dat_cumulative, family = 'nb', method = 'ML')
                           }
)
n1_1a_full_einkommen <- bake(file = 'results/fitted_models/SA/FULL_n1_1a_einkommen_ml.rds',
                             expr = {
                               gam(cases_wave1_1 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 45) + s(ags2, bs = 're', k = 16) +
...
n1_1a_full_arbeitswelt <- bake(file = 'results/fitted_models/SA/FULL_n1_1a_arbeitswelt_ml.rds',
                               expr = {
                                 gam(cases_wave1_1 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 45) + s(ags2, bs = 're', k = 16) +
...
n1_2a_full_bildung <- bake(file = 'results/fitted_models/SA/FULL_n1_2a_bildung_ml.rds',
                           expr = {
...
n1_2a_full_einkommen <- bake(file = 'results/fitted_models/SA/FULL_n1_2a_einkommen_ml.rds',
                             expr = {
                               gam(cases_wave1_2 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 70) + s(ags2, bs = 're', k = 16) +
                                     s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds) + s(TS_Einkommen_adj) + s(pop_dens) +
                                     s(perc_service) + s(perc_production) + s(cases_wave1_1_rate) +
...
n1_2a_full_arbeitswelt <- bake(file = 'results/fitted_models/SA/FULL_n1_2a_arbeitswelt_ml.rds',
                               expr = {
                                 gam(cases_wave1_2 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 70) + s(ags2, bs = 're', k = 16) +
                                       s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds) + s(TS_Arbeitswelt_adj) + s(pop_dens) +
                                       s(perc_service) + s(perc_production) + s(cases_wave1_1_rate) +
...
# Quick check of fits:
par(mfrow = c(2, 2))
gam.check(n1_1a_full_bildung, rep = 50)
gam.check(n1_1a_full_einkommen, rep = 50)
gam.check(n1_1a_full_arbeitswelt, rep = 50)

gam.check(n1_2a_full_bildung, rep = 50)
gam.check(n1_2a_full_einkommen, rep = 50)
gam.check(n1_2a_full_arbeitswelt, rep = 50)
...
# 
# Initial check:
# n1_1a_comp_bildung <- gam(cases_wave1_1 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 45) + s(ags2, bs = 're', k = 16) +
#                             s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds) + s(TS_Bildung_adj) + s(pop_dens) +
#                             s(perc_service) + s(perc_production) +
...
# n1_1a_comp_einkommen <- gam(cases_wave1_1 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 45) + s(ags2, bs = 're', k = 16) +
#                               s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds) + s(TS_Einkommen_adj) + s(pop_dens) +
#                               s(perc_service) + s(perc_production) +
...
#                               offset(log(pop)), data = dat_cumulative, family = 'nb', method = 'ML', select = TRUE)
# n1_1a_comp_arbeitswelt <- gam(cases_wave1_1 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 45) + s(ags2, bs = 're', k = 16) +
#                                 s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds) + s(TS_Arbeitswelt_adj) + s(pop_dens) +
#                                 s(perc_service) + s(perc_production) +
...
#                                 offset(log(pop)), data = dat_cumulative, family = 'nb', method = 'ML', select = TRUE)
# 
# n1_2a_comp_bildung <- gam(cases_wave1_2 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 70) + s(ags2, bs = 're', k = 16) +
#                             s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds) + s(TS_Bildung_adj) + s(pop_dens) +
#                             s(perc_service) + s(perc_production) + s(cases_wave1_1_rate) +
#                             ti(perc_18to64, pop_dens) + ti(perc_18to64, TS_Bildung_adj) + ti(pop_dens, TS_Bildung_adj) +
#                             ti(perc_lessthan18, pop_dens) + ti(perc_lessthan18, TS_Bildung_adj) +
#                             offset(log(pop)), data = dat_cumulative, family = 'nb', method = 'ML', select = TRUE)
# n1_2a_comp_einkommen <- gam(cases_wave1_2 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 70) + s(ags2, bs = 're', k = 16) +
#                               s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds) + s(TS_Einkommen_adj) + s(pop_dens) +
#                               s(perc_service) + s(perc_production) + s(cases_wave1_1_rate) +
#                               ti(perc_18to64, pop_dens) + ti(perc_18to64, TS_Einkommen_adj) + ti(pop_dens, TS_Einkommen_adj) +
#                               ti(perc_lessthan18, pop_dens) + ti(perc_lessthan18, TS_Einkommen_adj) +
#                               offset(log(pop)), data = dat_cumulative, family = 'nb', method = 'ML', select = TRUE)
# n1_2a_comp_arbeitswelt <- gam(cases_wave1_2 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 70) + s(ags2, bs = 're', k = 16) +
#                                 s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds) + s(TS_Arbeitswelt_adj) + s(pop_dens) +
#                                 s(perc_service) + s(perc_production) + s(cases_wave1_1_rate) +
#                                 ti(perc_18to64, pop_dens) + ti(perc_18to64, TS_Arbeitswelt_adj) + ti(pop_dens, TS_Arbeitswelt_adj) +
#                                 ti(perc_lessthan18, pop_dens) + ti(perc_lessthan18, TS_Arbeitswelt_adj) +
...
#                               s(perc_18to64) + s(perc_lessthan18) + s(care_home_beds) + s(TS_Einkommen_adj) + s(pop_dens) +
#                               s(perc_service) + s(perc_production) + s(cases_wave1_1_rate) +
#                               ti(pop_dens, TS_Einkommen_adj) + ti(perc_lessthan18, pop_dens) +
#                               offset(log(pop)), data = dat_cumulative, family = 'nb', method = 'ML')
#
# n1b_comp_bildung <- gam(deaths_wave1 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = 40) + s(ags2, bs = 're', k = 16) +
#                           s(hosp_beds) + s(care_home_beds) + s(TS_Bildung_adj) + s(pop_dens) + s(cases_wave1_rate) +
...
#                             offset(log(cases_wave4)), data = dat_cumulative, family = 'nb', method = 'ML')
# 
# anova(n1_1a_full_bildung, n1_1a_comp_bildung, test = 'Chisq')
# anova(n1_1a_full_einkommen, n1_1a_comp_einkommen, test = 'Chisq') # sig
# anova(n1_1a_full_arbeitswelt, n1_1a_comp_arbeitswelt, test = 'Chisq')
# 
# anova(n1_2a_full_bildung, n1_2a_comp_bildung, test = 'Chisq')
# anova(n1_2a_full_einkommen, n1_2a_comp_einkommen, test = 'Chisq')
# 
...
par(mfrow = c(2, 2))
check_dharma(dat_cumulative, n1_1a_full_bildung, depend = 'none')
check_dharma(dat_cumulative, n1_1a_full_einkommen, depend = 'none')
check_dharma(dat_cumulative, n1_1a_full_arbeitswelt, depend = 'none')

check_dharma(dat_cumulative, n1_2a_full_bildung, depend = 'none')
check_dharma(dat_cumulative, n1_2a_full_einkommen, depend = 'none')
check_dharma(dat_cumulative, n1_2a_full_arbeitswelt, depend = 'none')
...
dat_cumulative$resid_n1_1a_bildung <- residuals(n1_1a_full_bildung, type = 'deviance')
dat_cumulative$resid_n1_1a_einkommen <- residuals(n1_1a_full_einkommen, type = 'deviance')
dat_cumulative$resid_n1_1a_arbeitswelt <- residuals(n1_1a_full_arbeitswelt, type = 'deviance')
dat_cumulative$resid_n1_2a_bildung <- residuals(n1_2a_full_bildung, type = 'deviance')
dat_cumulative$resid_n1_2a_einkommen <- residuals(n1_2a_full_einkommen, type = 'deviance')
dat_cumulative$resid_n1_2a_arbeitswelt <- residuals(n1_2a_full_arbeitswelt, type = 'deviance')
...
map_base <- map_base %>%
  left_join(dat_cumulative %>%
              select(lk, resid_n1_1a_bildung:resid_n4b_arbeitswelt),
            by = c('ARS' = 'lk')) %>%
  drop_na()
...
moran.mc(map_base$resid_n1_1a_bildung, lw, nsim = 999)
moran.mc(map_base$resid_n1_1a_einkommen, lw, nsim = 999)
moran.mc(map_base$resid_n1_1a_arbeitswelt, lw, nsim = 999)
moran.mc(map_base$resid_n1_2a_bildung, lw, nsim = 999)
moran.mc(map_base$resid_n1_2a_einkommen, lw, nsim = 999)
moran.mc(map_base$resid_n1_2a_arbeitswelt, lw, nsim = 999)
...
summary(n1_1a_full)
summary(n1_1a_full_bildung)
summary(n1_1a_full_einkommen) # better?
summary(n1_1a_full_arbeitswelt) # better?

summary(n1_2a_full)
summary(n1_2a_full_bildung)
summary(n1_2a_full_einkommen)
summary(n1_2a_full_arbeitswelt)
...
mod_list <- list(n1_1a_full_bildung, n1_2a_full_bildung, n2a_full_bildung, n3a_full_bildung, n4a_full_bildung)
...
plot_a_einkommen_perc18to64 <- plot_marginal_prediction(pred_a_einkommen_perc18to64, c('TS_Einkommen_adj', 'perc_18to64'),
                                                        'Cases / 10000 Pop', single_plot = FALSE, which_waves = c('1_1', 2, 3))
...
plot_a_einkommen_popdens <- plot_marginal_prediction(pred_a_einkommen_popdens, c('TS_Einkommen_adj', 'pop_dens'),
                                                     'Cases / 10000 Pop', single_plot = FALSE, which_waves = c('1_1', 2))
...
grid.arrange(plot_a_einkommen_perc18to64[[1]][[1]],
             plot_a_einkommen_popdens[[1]][[1]]) # wave 1_1
