...
n1_1a_mods = n1_2a_mods = n1_1b_mods = n1_2b_mods = n2a_mods = n2b_mods = n3a_mods = n3b_mods = n4a_mods = n4b_mods = n5a_mods = n5b_mods = vector('list', length = length(seq(10, 150, by = 10)))
for (i in 1:length(seq(10, 150, by = 10))) {
  ...
  n1_1b_mods[[i]] <- gam(deaths_wave1_1 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = k_val) + s(ags2, bs = 're', k = 16) +
  ...
  n1_2b_mods[[i]] <- gam(deaths_wave1_2 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = k_val) + s(ags2, bs = 're', k = 16) +
                           s(hosp_beds) + s(care_home_beds) + s(GISD_Score) + s(pop_dens) +
                           s(cases_wave1_2_rate) + s(cases_wave1_1_rate) +
...
n1_1b_aics <- lapply(n1_1b_mods, AIC) %>% unlist()
n1_2b_aics <- lapply(n1_2b_mods, AIC) %>% unlist()
...
n1_1b_bics <- lapply(n1_1b_mods, BIC) %>% unlist()
n1_2b_bics <- lapply(n1_2b_mods, BIC) %>% unlist()
...
plot(seq(10, 150, by = 10), n1_1b_aics, pch = 20, type = 'b', xlab = 'k', ylab = 'AIC')
plot(seq(10, 150, by = 10), n1_1b_bics, pch = 20, type = 'b', xlab = 'k', ylab = 'BIC')

plot(seq(10, 150, by = 10), n1_2b_aics, pch = 20, type = 'b', xlab = 'k', ylab = 'AIC')
plot(seq(10, 150, by = 10), n1_2b_bics, pch = 20, type = 'b', xlab = 'k', ylab = 'BIC')
