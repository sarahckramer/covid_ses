...
n1_1a_mods = n1_2a_mods = n1b_mods = n2a_mods = n2b_mods = n3a_mods = n3b_mods = n4a_mods = n4b_mods = vector('list', length = length(seq(10, 150, by = 10)))
for (i in 1:length(seq(10, 150, by = 10))) {
  ...
  n1_2a_mods[[i]] <- gam(cases_wave1_2 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = k_val) + s(ags2, bs = 're', k = 16) +
                           ...
                           offset(log(pop)), data = dat_cumulative, family = 'nb', method = 'ML')
  # n1a_mods[[i]] <- gam(cases_wave1 ~ s(long, lat, bs = 'ds', m = c(1.0, 0.5), k = k_val) + s(ags2, bs = 're', k = 16) +
