...
# Wave 1:
n1_1a_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n1_1a_ml_NOSPATIAL.rds',
                   expr = {
...
n1_2a_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n1_2a_ml_NOSPATIAL.rds',
                   expr = {
...
n1_1b_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n1_1b_ml_NOSPATIAL.rds',
                   expr = {
...
n1_2b_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n1_2b_ml_NOSPATIAL.rds',
                   expr = {
...
# Wave 2:
n2a_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n2a_ml_NOSPATIAL.rds',
                 expr = {
...
n2b_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n2b_ml_NOSPATIAL.rds',
                 expr = {
...
# Wave 3:
n3a_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n3a_ml_NOSPATIAL.rds',
                 expr = {
...
n3b_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n3b_ml_NOSPATIAL.rds',
                 expr = {
...
# Wave 4:
n4a_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n4a_ml_NOSPATIAL.rds',
                 expr = {
...
n4b_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n4b_ml_NOSPATIAL.rds',
                 expr = {
...
# Wave 5:
n5a_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n5a_ml_NOSPATIAL.rds',
                 expr = {
...
n5b_full_NS <- bake(file = 'results/fitted_models/SA/FULL_n5b_ml_NOSPATIAL.rds',
                 expr = {
...
moran.mc(map_base$resid_n1_1b, lw, nsim = 999) # not sig
moran.mc(map_base$resid_n1_2b, lw, nsim = 999) # not sig
...
moran.mc(map_base$resid_n4b, lw, nsim = 999) # not sig
...
summary(n5a_full) # not sig
summary(n5a_full_NS)

summary(n1_1b_full) # not sig
summary(n1_1b_full_NS)

summary(n1_2b_full) # not sig
summary(n1_2b_full_NS)
...
summary(n5b_full) # not sig
summary(n5b_full_NS)

# AIC(n1_1a_full, n1_1a_full_NS)
# AIC(n1_2a_full, n1_2a_full_NS)
# AIC(n2a_full, n2a_full_NS)
# AIC(n3a_full, n3a_full_NS)
# AIC(n4a_full, n4a_full_NS)
# AIC(n5a_full, n5a_full_NS)
# 
# BIC(n1_1a_full, n1_1a_full_NS)
# BIC(n1_2a_full, n1_2a_full_NS)
# BIC(n2a_full, n2a_full_NS)
# BIC(n3a_full, n3a_full_NS)
# BIC(n4a_full, n4a_full_NS)
# BIC(n5a_full, n5a_full_NS)
# 
# AIC(n1_1b_full, n1_1b_full_NS)
# AIC(n1_2b_full, n1_2b_full_NS)
# AIC(n2b_full, n2b_full_NS)
# AIC(n3b_full, n3b_full_NS)
# AIC(n4b_full, n4b_full_NS)
# AIC(n5b_full, n5b_full_NS)
# 
# BIC(n1_1b_full, n1_1b_full_NS)
# BIC(n1_2b_full, n1_2b_full_NS)
# BIC(n2b_full, n2b_full_NS)
# BIC(n3b_full, n3b_full_NS)
# BIC(n4b_full, n4b_full_NS)
# BIC(n5b_full, n5b_full_NS)
